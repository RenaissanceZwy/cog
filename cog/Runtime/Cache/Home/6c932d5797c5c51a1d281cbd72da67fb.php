...
<body>
   <div class="nav-container">
      <img class="nav-logo" src="" title="logo">
      <img class="nav-caption" src="" title="发现另一个你！">
    <ul class="nav-bar">
    ...
    <?php if(is_array($res_user)): $i = 0; $__LIST__ = $res_user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><a href="<?php echo (URL); ?>MyInfo/index" class="touxiang"><img src="/cog/<?php echo ($user["user_headimg"]); ?>"></a>
    </div>
      ...
      <div class="user-container">
               <img src="/cog/<?php echo ($user["user_headimg"]); ?>"title="头像" class="avator">
                 ...
                 <p class="fix-position"><span><?php echo ($user["user_addr"]); ?></span></p>
                 <p class="circle-age"><span>圈龄:</span><span>1.5年</span></p>
                 <p class="my-level"><span>等级：</span><span><?php echo ($user["user_level"]); ?></span></p>
          <div class="attention">
              <span>关注:<a href="#">99</a></span>
              <span>被关注:<a href="#">100</a></span>
          </div>
         <div class="subscribe">
            关注列表</br>
            <?php if(is_array($res_subscribe)): $i = 0; $__LIST__ = $res_subscribe;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i; if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$subscribe): $mod = ($i % 2 );++$i;?><span>
              <a href="<?php echo (URL); ?>MyInfo/index?user_id=<?php echo ($subscribe["user_id"]); ?>"><?php echo ($subscribe["user_name"]); ?></a> 
      
            <!--   <input type="button" class="cancel_subscribe" value="取消关注" data-id="<?php echo ($subscribe["user_id"]); ?>"/> --> </br>
              </span><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
           </div>
          <div class="subscribed">
            被关注列表</br>
             <?php if(is_array($res_subscribed)): $i = 0; $__LIST__ = $res_subscribed;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><span>
              <a href="<?php echo (URL); ?>MyInfo/index?user_id=<?php echo ($data["user_id"]); ?>"><?php echo ($data["user_name"]); ?></a> </br>
          ...
          <a class="private-chat change" href="#"  style="display:none">查看私聊</a>
          <a class="modify"  href="#" target="_blank" style="display:none">修改个人信息
          </a>
   ...
   <div class="container">
            <div class="actions-container" >
                <ul class="actions-select">
                    ...
                    <li>发帖</li>
                    <li>回复 <?php echo ($mention); ?></li>
                    <li style="border-right: 1px solid black" >TA收藏的贴子</li>
                </ul>
                <div class="clear-float"></div>
                <!--动态-->
                <div class="tabcontent">
                   <?php if(is_array($res_post)): $i = 0; $__LIST__ = $res_post;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$post): $mod = ($i % 2 );++$i;?><div class="send">
                        ...
                        <div class="note-content">
                            <p class="head"><span><a href="<?php echo (URL); ?>User/index/post_id=<?php echo ($post["post_id"]); ?>"><?php echo ($post["post_title"]); ?></a></span><span style="left:410px ">·<a href="#"><?php echo ($post["circle_name"]); ?></a></span><span  style="margin-left:610px">·<?php echo ($post["post_game"]); ?></span><span style="margin-left: 800px"><?php echo ($post["post_time"]); ?></span></p>
                            <p class="note-subcontent"><?php echo ($post["post_content"]); ?></p>
                        </div>
                    </div><?php endforeach; endif; else: echo "" ;endif; ?>
                  <?php if(is_array($res_reply)): $i = 0; $__LIST__ = $res_reply;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$reply): $mod = ($i % 2 );++$i;?><div class="reply">
                        <p class="font">回复</p>
                        <a  href="#" class="name">
                           <?php echo ($reply["user_name"]); ?>
                        </a>
                        <div class="note-content">
                            <p class="head"><span><a href="<?php echo (URL); ?>User/index/post_id=<?php echo ($reply["post_id"]); ?>"><?php echo ($reply["post_title"]); ?></a></span><span style="left:410px ">·<a href="#"><?php echo ($reply["circle_name"]); ?></a></span><span  style="margin-left:610px">·<?php echo ($reply["post_game"]); ?></span><span style="margin-left: 800px"><?php echo ($reply["comment_time"]); ?></span></p>
                            <p class="note-subcontent"><?php echo ($reply["comment_content"]); ?></p>
                        </div>
                    </div><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <!--发帖-->
                <div class="tabcontent" style="display: none">
                  <?php if(is_array($res_post)): $i = 0; $__LIST__ = $res_post;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$post): $mod = ($i % 2 );++$i;?><div  class="post-note">
                            <p class="head"><span><a href="<?php echo (URL); ?>User/index/post_id=<?php echo ($post["post_id"]); ?>"><?php echo ($post["post_title"]); ?></a></span>
                              <span style="left:410px ">·<a href="#"><?php echo ($post["circle_name"]); ?></a></span>
                              <span  style="margin-left:610px">·<?php echo ($post["post_game"]); ?></span>
                              <span style="margin-left: 800px"><?php echo ($post["post_time"]); ?></span></p>
                            <p class="note-subcontent"><?php echo ($post["post_content"]); ?> </p>
                    </div><?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
     ...
     <!--回复帖子-->
                <div class="tabcontent" style="display: none">
                  ...
                  <!-- 用户未读信息 -->
                  <?php if(is_array($res_mention)): $i = 0; $__LIST__ = $res_mention;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$reply): $mod = ($i % 2 );++$i;?><div class="reply-note">
                            <p class="head"><span><a href="<?php echo (URL); ?>User/index/post_id=<?php echo ($post["post_id"]); ?>"><?php echo ($reply["post_title"]); ?></a></span><span style="left:410px ">·<a href="#"><?php echo ($reply["circle_name"]); ?></a></span><span  style="margin-left:610px">·<?php echo ($reply["post_game"]); ?></span><span style="margin-left: 800px"><?php echo ($reply["comment_time"]); ?></span></p>
                            <p class="reply-note-subcontent"><a href="#">:<?php echo ($reply["user_name"]); ?></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($reply["comment_content"]); ?></p>
                        </div><?php endforeach; endif; else: echo "" ;endif; ?>
                  <?php if(is_array($res_reply)): $i = 0; $__LIST__ = $res_reply;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$reply): $mod = ($i % 2 );++$i;?><div class="reply-note">
                            <p class="head"><span><a href="<?php echo (URL); ?>User/index/post_id=<?php echo ($post["post_id"]); ?>"><?php echo ($reply["post_title"]); ?></a></span><span style="left:410px ">·<a href="#"><?php echo ($reply["circle_name"]); ?></a></span><span  style="margin-left:610px">·<?php echo ($reply["post_game"]); ?></span><span style="margin-left: 800px"><?php echo ($reply["comment_time"]); ?></span></p>
                            <p class="reply-note-subcontent"><a href="#">:<?php echo ($reply["user_name"]); ?></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($reply["comment_content"]); ?></p>
                        </div><?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
